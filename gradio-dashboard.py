...
books["large_thumbnail"] = books["thumbnail"] + "&fife=w500"
...
def retrieve_semantic_recommendations(
    ...
    if tone == "Happy":
        ...
        book_recs.sort_values(by="anger", ascending=True, inplace=True)
    elif tone == "Suspenseful":
        book_recs.sort_values(by="fear", ascending=True, inplace=True)
    elif tone == "Sad":
        book_recs.sort_values(by="sadness", ascending=True, inplace=True)
...
with gr.Blocks(theme = gr.themes.Glass()) as dashboard:
    ...
    with gr.Row():
        user_query = gr.Textbox(label='Please enter a description of a book which you want to read:', placeholder='e.g., A story about forgiveness')
